...
```{r Replicated Fams}
CilDatJar<- ddply(CilDat, .(JarID, ParentTrt, FemaleID, MaleID, Batchciliaarea,CrossID), numcolwise(mean, na.rm=T))
CilDatJarSE<- ddply(CilDat, .(JarID, ParentTrt, FemaleID, MaleID, Batchciliaarea,CrossID), numcolwise(se, na.rm=T))
