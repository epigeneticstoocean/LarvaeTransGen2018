...
jpeg("Fig5.jpeg", height = 700, width= 500)
ggplot(SurvDat,aes(x=JarTrt, y=LarvaeSurvived, color = "black45", group= CrossID)) +
  ...
  theme(panel.spacing = unit(0.2, "mm"),                    # remove spacing between facets
        strip.background = element_rect(colour="white", fill="white"), panel.border= element_blank(), legend.position="none", text= element_text(size=14))
dev.off()
