---
title: "LarvaeMorphologyPlots"
output: html_document
---

("~/Desktop/Repos/LarvaeTransGen2018")
...
# Load data
```{r}
gs_title("Larvae data 2018 cross exposure experiment") %>%
  gs_download(ws = "Larvae_Morphology", "Larvae_Morphology.csv", overwrite = TRUE)
larvmorph <- read.csv("~/-Larvae/Larvae_Morphology_Latest.csv", header = TRUE, sep = ",")

larvmorph <- larvmorph %>%
  mutate(CrossID = as.character(CrossID)) %>%
