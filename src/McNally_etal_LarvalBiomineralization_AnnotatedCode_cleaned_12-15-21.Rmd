...
```{r MultipanelFigure}
par(mfcol=c(3,1), mar=c(2.5,2, .1,.5), xpd=TRUE, pty="s")


p1<- visreg(larvgrowfin, "JarSatArg_Total", by="ParentTrt", overlay=TRUE, ylab=expression(paste("Growth (", mu, "m/day)")), xlab="", legend=FALSE, line=list(col=c( "#F7645A", "#004D4F"), lwd=c(2,2)),
...
#p2<-visreg(larvlenfin, "JarSatArg_Total", by="ParentTrt", overlay=TRUE, ylab=expression(paste("Length (", mu, "m)")),  xlab=expression(paste("Larvae Treatment ", Omega[Aragonite])), legend=FALSE, line=list(col=c( "#F7645A", "#004D4F"), lwd=c(2,2)), fill=list(col=c("#FCCECB", "#3BFAFF")), points=list(col=c("#F98880", "#007367"), pch=19, cex=0.4))

p3<-visreg(larvareafint, "JarSatArg_Total", by="ParentTrt", overlay=TRUE, ylab=expression(sqrt(paste("Area (", mu, m^2,")"))), xlab="", legend=FALSE, cex=0.6, line=list(col=c( "#F7645A", "#004D4F"), lwd=c(2,2)),
              fill=list(col=c("#FCCECB", "#3BFAFF")),
        points=list(col=c("#F98880", "#007367"), pch=19, cex=0.4))
...
pdf(paste0("fig3a.pdf"), height = 5, width = 5)
visreg(larvgrowfin, "JarSatArg_Total", by="ParentTrt", overlay=TRUE, ylab=expression(paste("Growth (", mu, "m/day)")), xlab="", legend=FALSE, line=list(col=c( "#F7645A", "#004D4F"), lwd=c(2,2)),
              fill=list(col=c("#FCCECB", "#3BFAFF")),
        points=list(col=c("#F98880", "#007367"), pch=19, cex=0.4))
dev.off()
